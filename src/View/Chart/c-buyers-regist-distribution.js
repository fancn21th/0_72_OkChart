...
BuyersRegistChartDistribution.prototype = {
    ...
    render: function(data) {
        ...
        this.chart.guide().html({
            position: ['50%', '50%'],
            html: '<div style="color:#8c8c8c;font-size: 14px;text-align: center;width: 10em;">注册买家分布</div>',
            alignX: 'middle',
            alignY: 'middle'
        });
        var interval = this.chart.intervalStack().position('percent').color('item').label('percent', {
